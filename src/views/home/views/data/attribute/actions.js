...
const titleTipsShow = function ({}, type, {clientX, clientY, offsetX, offsetY, target}) {
  ...
  switch (type) {
    case 1:
      _this.titleTipsTxt = '截止统计时间，该医生账户所有新增用户的总和，以及环比增长比例。<br><br>环比新增比例是指在日、月、年维度下，本期的新增用户数据占上一期的用户总数的比例。'
      break
    case 2:
      ...
      break
    case 3:
      _this.titleTipsTxt = '截止统计时间，该医生账户的所有用户的年龄构成情况，按照小于25岁，26到35岁，36到55岁，56到65岁，65岁以上的年龄段划分用户，并统计每一年龄段的用户人数和占比。'
      break
    case 4:
      _this.titleTipsTxt = '截止统计时间，该医生账户的所有用户中，来自公众号渠道、乐心医生app渠道以及健康管理平台渠道的用户的占比。'
      break
    case 5:
      _this.titleTipsTxt = '截止统计时间，该医生账户的所有用户的性别比例。'
      break
    case 6:
      _this.titleTipsTxt = '截止统计时间，该医生账户的所有用户中，已绑定设备的用户与未绑定设备用户的比例。'
      break
  }
