  ...
  export default {
    ...
    data () {
      ...
      return {
        ...
        messageIcons:{
          icon1:require('!raw-loader!!../../../../static/admin/icon_message_dialogue.svg'),
          icon2:require('!raw-loader!!../../../../static/admin/icon_message_datawarning.svg'),
          icon3:require('!raw-loader!!../../../../static/admin/icon_message_link.svg'),
          icon4:require('!raw-loader!!../../../../static/admin/icon_message_send.svg'),
        },
        toolIcons: {
          icon1:require('!raw-loader!!../../../../static/admin/icon_head_personal.svg'),
          icon2:require('!raw-loader!!../../../../static/admin/icon_head_password.svg'),
          icon3:require('!raw-loader!!../../../../static/admin/icon_head_signout.svg'),
        },
